...
- Put the user-visible summary, compatibility/configuration impact, and verification commands in that file. Include an explicit `## Verification` section; release workflow checks require this heading for both products' latest notes.
